...
def create_distribution(angledata, obs):
    ...
    l0 = zfit.Parameter('l0', 0.1, -10, 10)
    l1 = zfit.Parameter('l1', 0.1, -10, 10)
    l2 = zfit.Parameter('l2', 0.1, -10, 10)

    k0 = zfit.Parameter('k0', 0.1, -10, 10)
    k1 = zfit.Parameter('k1', 0.1, -10, 10)
    k2 = zfit.Parameter('k2', 0.1, -10, 10)

    p0 = zfit.Parameter('p0', 0.1, -10, 10)
    p1 = zfit.Parameter('p1', 0.1, -10, 10)
    p2 = zfit.Parameter('p2', 0.1, -10, 10)
